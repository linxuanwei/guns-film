...
-- ----------------------------
INSERT INTO mooc_banner_t(banner_address, banner_url)
...
-- ----------------------------
INSERT INTO mooc_cat_dict_t(uuid, show_name)
values (99, '全部');
INSERT INTO mooc_cat_dict_t(uuid, show_name)
values (1, '爱情');
INSERT INTO mooc_cat_dict_t(uuid, show_name)
...
-- ----------------------------
INSERT INTO mooc_source_dict_t(uuid, show_name)
values (99, '全部');
INSERT INTO mooc_source_dict_t(uuid, show_name)
values (1, '大陆');
INSERT INTO mooc_source_dict_t(uuid, show_name)
...
-- ----------------------------
INSERT INTO mooc_year_dict_t(uuid, show_name)
values (99, '全部');
INSERT INTO mooc_year_dict_t(uuid, show_name)
values (1, '更早');
INSERT INTO mooc_year_dict_t(uuid, show_name)
...
-- ----------------------------
INSERT INTO mooc_film_t(uuid, film_name, film_source, film_type, film_cats, film_area, film_date, film_time,
...
-- ----------------------------
INSERT INTO mooc_film_info_t(film_id, film_en_name, film_score, film_score_num, film_length, director_id, film_imgs,
                             biography)
